...
if __name__ == '__main__':
	dataset_dir = "1D_dataset_default/Group/"
	use_baseline = 'yes' # yes or no
	if use_baseline=="yes":
		result_dir = "3D_dataset_default_fractional/Group/with_base/"
		if os.path.isdir(result_dir)==False:
			os.makedirs(result_dir)
	else:
		result_dir = "3D_dataset_default_fractional/Group/without_base/"
		if os.path.isdir(result_dir)==False:
			os.makedirs(result_dir)
