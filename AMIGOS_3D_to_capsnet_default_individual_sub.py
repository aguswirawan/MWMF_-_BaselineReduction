...
if __name__ == '__main__':
    ...
    label = 'all'
    if use_baseline=='yes':
        dataset_dir = '3D_dataset_default_sub/Individual/with_base/'
    else:
        dataset_dir = '3D_dataset_default_sub/Individual/without_base/'

    result_dir = f'amigos_shuffled_default_sub/Individual/{use_baseline}_{label}/'
