...
if __name__ == '__main__':
    ...
    label = 'all'
    if use_baseline=='yes':
        dataset_dir = '3D_dataset_default_sub/Group/with_base/'
    else:
        dataset_dir = '3D_dataset_default_sub/Group/without_base/'

    result_dir = f'amigos_shuffled_default_sub/Group/{use_baseline}_{label}/'
