...
def read_file(file):
	...
	return trial_data,base_data,file["arousal_labels"],file["valence_labels"],file['dominance_labels'],file['data_seconds_list']
...
if __name__ == '__main__':
	dataset_dir = "1D_dataset_MWMF/"
	use_baseline = 'yes' # yes or no
	if use_baseline=="yes":
		result_dir = "3D_dataset_MWMF_div/with_base/"
		if os.path.isdir(result_dir)==False:
			os.makedirs(result_dir)
	else:
		result_dir = "3D_dataset_MWMF_div/without_base/"
		if os.path.isdir(result_dir)==False:
			os.makedirs(result_dir)
