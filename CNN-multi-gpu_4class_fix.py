...
def data_load(data_file,dimention,debaseline):
    ...
    dataset_dir = "dreamer_shuffled_MWMF_sub/" + with_or_without + "_" + arousal_or_valence + "/"
...
subjects = ['res06','res07','res09','res12','res13','res19','res22'] 
# subjects = ['res01','res02','res03','res04','res05','res08','res10','res11','res14','res15', 'res16','res17', 'res18', 'res20', 'res21','res23'] 
...
if __name__ == "__main__":
    for dimention in dimentions:
        for subject in subjects:
            ...
            parser.add_argument('--save_dir', default='result_MWMF_sub/sub_dependent_'+ model_version +'/') # other
